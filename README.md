About spyne-feedstock
=====================

Feedstock license: [BSD-3-Clause](https://github.com/conda-forge/spyne-feedstock/blob/main/LICENSE.txt)
...
<table><tr><td>All platforms:</td>
    <td>
      <a href="https://dev.azure.com/conda-forge/feedstock-builds/_build/latest?definitionId=1958&branchName=main">
        <img src="https://dev.azure.com/conda-forge/feedstock-builds/_apis/build/status/spyne-feedstock?branchName=main">
      </a>
    </td>
  </tr>
</table>
...
Once the `conda-forge` channel has been enabled, `spyne` can be installed with `conda`:
...
It is possible to list all of the versions of `spyne` available on your platform with `conda`:
...
```
mamba search spyne --channel conda-forge
```
...
mamba repoquery search spyne --channel conda-forge

# List packages depending on `spyne`:
mamba repoquery whoneeds spyne --channel conda-forge

# List dependencies of `spyne`:
mamba repoquery depends spyne --channel conda-forge
```
